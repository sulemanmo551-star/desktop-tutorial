...
(() => {
  ...
  nativeImportScripts('worker-engine.js?v=20260727-final5');
  nativeImportScripts('worker-matching-fix.js?v=20260727-final5');
  nativeImportScripts('worker-final-fix.js?v=20260727-final5');
})();